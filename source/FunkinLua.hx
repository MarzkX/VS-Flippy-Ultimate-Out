	...
	public function new(script:String) {
		...
		Lua_helper.add_callback(lua, "keyJustPressed", function(name:String) {
			...
			switch(name) {
				...
				case 'key5': key = PlayState.instance.getControl('KEY5');
		...
		Lua_helper.add_callback(lua, "oppoMissHealth", function(yesorno:Bool, health:Float, missHealth:Float) {
			if(yesorno == true) 
			{
			    PlayState.instance.oppoMissHealth = true;
				PlayState.instance.healthOppo = health;
				PlayState.instance.oppoHMiss = missHealth;
			} else {
				PlayState.instance.oppoMissHealth = false;
				PlayState.instance.healthOppo = 0;
				PlayState.instance.oppoHMiss = 0;
			}
		});
