...
typedef WeekFile =
{
	...
	var freeplayString:String;
	var startUnlocked:Bool;
	var hiddenUntilUnlocked:Bool;
	var hideStoryMode:Bool;
	var hideFreeplay:Bool;
	var artsDifferent:Bool;
...
class WeekData {
	...
	public var freeplayString:String;
	public var startUnlocked:Bool;
	public var hiddenUntilUnlocked:Bool;
	public var hideStoryMode:Bool;
	public var hideFreeplay:Bool;
	public var artsDifferent:Bool;
	...
	public static function createWeekFile():WeekFile {
		var weekFile:WeekFile = {
			songs: [["Triggered", "flippy", [146, 113, 253], 'og'], ["Slaughter", "flippy", [146, 113, 253], 'bloody'], ["Overkill", "flippy", [146, 113, 253], 'insane'], ["Fallout", 'flippy', [146, 113, 253], 'fearful']],
			weekCharacters: ['', '', ''],
			weekBackground: 'MainBG',
			weekBefore: 'tutorial',
	...
	public function new(weekFile:WeekFile, fileName:String) {
		...
		freeplayString = weekFile.freeplayString;
		startUnlocked = weekFile.startUnlocked;
		hiddenUntilUnlocked = weekFile.hiddenUntilUnlocked;
		hideStoryMode = weekFile.hideStoryMode;
		hideFreeplay = weekFile.hideFreeplay;
		artsDifferent = weekFile.artsDifferent;
